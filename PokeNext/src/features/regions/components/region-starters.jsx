...
export default function RegionStarters({ region }) {
    ...
    const startersByRegion = useMemo(() => ({
        kanto: [1, 4, 7],
        johto: [152, 155, 158],
        hoenn: [252, 255, 258],
        sinnoh: [387, 390, 393],
    ...
    const { loading, pokemon: pokemons } = useRegionPokemon(ids);
                            ...
                            >
                                ...
                                <div className="flex gap-1">
                                    {pokemon.types.slice(0, 2).map(tp => (
                                        <span
                                            key={tp.code}
                                            className={`px-2 py-1 rounded text-[10px] font-extrabold capitalize ${getTypeClass(tp.code)}`}
                                        >
                                            {tp.label}
                                        </span>
                                    ))}
