          ...
          `}
                >
                  ...
                  "
                    ...
                    {loading && !allMoves.length && (
                        <p className="text-white/80 text-sm mt-2">Carregando lista...</p>
                    )}
                </motion.div>
                                    ...
                                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                                        ...
                                        <div className="lg:col-span-7">
                                            <div className="flex items-start justify-between gap-4 mb-3">
                                                <h3 className="text-white text-lg font-semibold">Tipo</h3>
                                                ...
                                                {ALL_TYPES.map((t) => {
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            className="flex items-center justify-between gap-2 rounded-md px-2 py-2 hover:bg-white/10 transition"
                                                            title="Selecionar tipo"
                                                        >
                                                            <span
                                                                className={`min-w-[140px] px-3 py-1 rounded-md text-xs font-semibold text-center ${getTypeClass(
                                                                    t
                                                                )}`}
                                                            >
                                                            ...
                                                            <span
                                                                className={`inline-flex items-center justify-center w-7 h-7 rounded-full border text-xs font-bold transition
                                  ${selected
                                        ...
                                        <div className="lg:col-span-5">
                                            ...
                                            <div className="mb-5">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full bg-white text-neutral-900 px-3 py-2 rounded-md border border-white/10 focus:outline-none"
                                                />
                                            </div>
                                    ...
                                    <div className="mt-6 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-2">
                                        {/* INFO */}
                                        <div className="text-white/80 text-sm">
                                            Aplique os filtros e clique em{" "}
                                        ...
                                        <div className="flex items-center gap-3 justify-start lg:justify-end">
                                            ...
                                            <button
                                                ...
                                                className="px-5 py-2 rounded-md bg-[#E3350D] text-white hover:bg-[#c52c0b] flex items-center gap-2"
                                            >
