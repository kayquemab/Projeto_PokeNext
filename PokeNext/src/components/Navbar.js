      ...
      >
        <div className="flex items-center justify-between h-12 relative">
          ...
          <Link href="/" className="flex items-center gap-3 text-[#333333]">
            <div className="size-8 text-[#E3350D]">
              <svg fill="none" viewBox="0 0 48 48">
                <path d="M24 4C12.9543 4 4 12.9543 4 24C4 35.0457 12.9543 44 24 44C35.0457 44 44 35.0457 44 24C44 12.9543 35.0457 4 24 4ZM24 38C16.268 38 10 31.732 10 24C10 16.268 16.268 10 24 10C31.732 10 38 16.268 38 24C38 31.732 31.732 38 24 38Z" fill="currentColor" />
          ...
          <nav className="hidden md:flex items-center gap-6">
            {menu.map((item) => (
              <Link
                key={item.href}
                href={item.href}
                className="text-sm font-medium text-[#333333] hover:text-[#E3350D] transition-colors duration-200"
              >
                {item.label}
              </Link>
            ))}
          ...
          <button
            ...
            className="md:hidden text-2xl font-bold text-[#333333]"
          >
            {open ? "✕" : "☰"}
          </button>
