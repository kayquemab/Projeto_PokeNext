...
import { translateTypeName } from "@/shared/poke-api";
import { useRegionPokemon } from "../hooks/use-regions-api";
...
export default function Lideres({ region = "kanto" }) {
    ...
    const { loading, pokemon } = useRegionPokemon(allIds);
    const pokeCache = useMemo(
                                ...
                                {loading ? (
                                    ...
                                    <div className="flex flex-wrap gap-3 justify-center">
                                        {(leader.teamIds || []).map((pid) => {
                                            ...
                                            const name = pokemon?.displayName || "Pokémon";
