 ...
 * @typedef {{ id: number, slug: string, displayName: string, artworkUrl: string, heightDecimeters: number, weightHectograms: number, speciesUrl: string, types: PokemonType[], abilities: PokemonAbility[], stats: PokemonStat[] }} Pokemon
