                        ...
                        <div className="flex items-center justify-between mb-6">
                            <div className="flex items-center gap-2">
                                ...
                                <h3 className="text-xl font-extrabold text-black dark:text-white">
                                    Pokémons Iniciais de {region.charAt(0).toUpperCase() + region.slice(1)}
                                </h3>
                                
                                <p className="text-zinc-400">
                                    pokemons iniciais que jovens treinadores podem escolher no começo de sua jornada na região de {region.charAt(0).toUpperCase() + region.slice(1)}.
                                </p>
                            </div>
